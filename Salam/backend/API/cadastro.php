...
<html lang="pt-br">
    <head>
        ...
        .logo{font-size:52px;font-weight:bold;text-shadow:3px 3px #555} .nav a{color:white;margin:0 30px;text-decoration:none} 
        ...
        <body>
            <div class="topbar">
                ...
                <div class="sidebar">
                    ...
                    <a href="cadastro.php">Agendamentos</a></div>
                    <div class="content">
                        <div class="card">
