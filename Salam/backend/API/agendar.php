...
<html lang="pt-br">
    <head>
        ...
        <title>Agendar</title>
        <style>
        body{margin:0;font-family:Arial;background:#e7d2d4} 
        ...
        <body>
            <div class="topbar">
                ...
                <div class="sidebar"><a href="agendar.php">
                    Agendar Serviço</a><a href="serviço.php">
                        Avaliar Profissionais</a><a href="cupom.php">
                            Cupons</a><a href="cadastro.php">
                                Agendamentos</a></div>
                                <div class="content">
                                    <div class="card">
